---
name: jelly_earning_summary
description: '사용자가 지난달 등 특정 월에 젤리를 몇 개 모았는지 물을 때 사용합니다. 예: "지난달 젤리 몇 개 모았어?"'
metadata:
  domain: monimo
  sector: non_finance
  case_type: normal
...
## 응답 가이드
- 현재 일 기준, d-1일로 하여 '젤리보관함' 내 젤리 개수 합산하여
...
```python
# -*- coding: utf-8 -*-
"""Hook script for skill `jelly_earning_summary` (자동 생성).
...
SKILL_NAME = 'jelly_earning_summary'
CASE_TYPE = 'normal'
FLOW = 'query'
