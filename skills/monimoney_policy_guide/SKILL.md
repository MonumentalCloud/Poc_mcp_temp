...
3. `monimoney_info_inquiry` 툴을 호출해 모니머니 출금한도·유효기간 등 관리 정보를 조회합니다.
...
```python
# -*- coding: utf-8 -*-
"""Hook script for skill `monimoney_policy_guide` (자동 생성).
...
SKILL_NAME = 'monimoney_policy_guide'
CASE_TYPE = 'normal'
FLOW = 'query'
REQUIRED_TOOLS = ['faq_search', 'monimoney_info_inquiry']
