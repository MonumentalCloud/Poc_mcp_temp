...
```python
# -*- coding: utf-8 -*-
"""Hook script for skill `monischool_answer_submit` (자동 생성).
...
SKILL_NAME = 'monischool_answer_submit'
CASE_TYPE = 'normal'
FLOW = 'action'
REQUIRED_TOOLS = ['monischool_quiz_inquiry', 'monischool_answer_submit']
ACTION_TOOLS = ['monischool_answer_submit']    # 사용자 확인(confirmed=True) 없이는 호출 금지
