---
name: zodiac_fortune_inquiry
description: '사용자가 양띠 등 특정 띠의 오늘의 운세를 물을 때 사용합니다. 예: "양띠의 오늘의 운세 알려줘"'
metadata:
  domain: casual
  sector: non_finance
  case_type: normal
...
## 응답 가이드
- (사주.띠 정보 미입력의 경우) 정보입력요청
- 요청한 정보에 맞는 오늘의 운세 안내
...
```python
# -*- coding: utf-8 -*-
"""Hook script for skill `zodiac_fortune_inquiry` (자동 생성).
...
SKILL_NAME = 'zodiac_fortune_inquiry'
CASE_TYPE = 'normal'
FLOW = 'query'
REQUIRED_TOOLS = ['fortune_inquiry']
