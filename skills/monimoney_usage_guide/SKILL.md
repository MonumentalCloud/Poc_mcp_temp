...
## 응답 가이드
- 충전/송금/결제, 투자, 보험료납입에 대한 안내 제공
- 모니머니 활용화면으로 이동 가능한 배너 제공
...
```python
# -*- coding: utf-8 -*-
"""Hook script for skill `monimoney_usage_guide` (자동 생성).
...
SKILL_NAME = 'monimoney_usage_guide'
CASE_TYPE = 'normal'
FLOW = 'query'
REQUIRED_TOOLS = ['faq_search']
