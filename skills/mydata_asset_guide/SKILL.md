...
2. `asset_summary_inquiry` 툴을 호출해 마이데이터 기반 통합자산 요약을 조회합니다.
...
```python
# -*- coding: utf-8 -*-
"""Hook script for skill `mydata_asset_guide` (자동 생성).
...
SKILL_NAME = 'mydata_asset_guide'
CASE_TYPE = 'normal'
FLOW = 'query'
REQUIRED_TOOLS = ['asset_summary_inquiry', 'menu_search']
