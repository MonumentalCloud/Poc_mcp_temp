...
- `insurance_premium_estimate(product_code: str, age_group: str, gender: str)` — 보험상품의 연령대·성별 기준 예상 보험료를 조회합니다
...
```python
# -*- coding: utf-8 -*-
"""Hook script for skill `insurance_premium_inquiry` (자동 생성).
...
SKILL_NAME = 'insurance_premium_inquiry'
CASE_TYPE = 'normal'
FLOW = 'query'
REQUIRED_TOOLS = ['product_search', 'insurance_premium_estimate']
