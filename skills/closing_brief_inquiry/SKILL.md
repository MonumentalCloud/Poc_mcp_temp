...
- `daily_news_inquiry(news_type: str = 'newsletter')` — 오늘의 소식(뉴스레터/마감브리핑)을 조회합니다
...
```python
# -*- coding: utf-8 -*-
"""Hook script for skill `closing_brief_inquiry` (자동 생성).
...
SKILL_NAME = 'closing_brief_inquiry'
CASE_TYPE = 'normal'
FLOW = 'query'
REQUIRED_TOOLS = ['daily_news_inquiry']
