...
- `branch_search(region: str, service: Optional[str] = None)` — 지역 기준으로 지점/플라자 위치·업무시간·전화번호·주차정보를 조회합니다
...
```python
# -*- coding: utf-8 -*-
"""Hook script for skill `branch_search` (자동 생성).
...
SKILL_NAME = 'branch_search'
CASE_TYPE = 'normal'
FLOW = 'query'
REQUIRED_TOOLS = ['branch_search']
