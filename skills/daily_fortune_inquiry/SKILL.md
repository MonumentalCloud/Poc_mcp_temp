...
5. 운세 요약 정보를 안내하고, 세부내용 확인 가능한 화면 이동 배너를 제공합니다.
...
## 응답 가이드
- 요청한 사주정보에 맞는 오늘의 운세 요약정보 제공
- 세부내용 확인 가능한 화면 이동버튼 안내
...
```python
# -*- coding: utf-8 -*-
"""Hook script for skill `daily_fortune_inquiry` (자동 생성).
...
SKILL_NAME = 'daily_fortune_inquiry'
CASE_TYPE = 'normal'
FLOW = 'query'
REQUIRED_TOOLS = ['saju_profile_inquiry', 'fortune_inquiry']
