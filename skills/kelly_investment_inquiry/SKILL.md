...
2. `kelly_investment_inquiry` 툴을 호출해 누계 켈리 투자금액과 투자 현황을 조회합니다.
...
## 응답 가이드
- 현재 일 기준, d-1일로 하여 '켈리보관함' 내 전환된 켈리 투자...
...
```python
# -*- coding: utf-8 -*-
"""Hook script for skill `kelly_investment_inquiry` (자동 생성).
...
SKILL_NAME = 'kelly_investment_inquiry'
CASE_TYPE = 'normal'
FLOW = 'query'
REQUIRED_TOOLS = ['kelly_investment_inquiry']
