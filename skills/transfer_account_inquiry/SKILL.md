...
2. `transfer_account_inquiry` 툴을 호출해 최근 송금 이력·즐겨찾기 기반 송금 가능 계좌 목록을 조회합니다.
...
```python
# -*- coding: utf-8 -*-
"""Hook script for skill `transfer_account_inquiry` (자동 생성).
...
SKILL_NAME = 'transfer_account_inquiry'
CASE_TYPE = 'normal'
FLOW = 'query'
REQUIRED_TOOLS = ['transfer_account_inquiry']
