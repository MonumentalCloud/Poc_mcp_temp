...
- `product_compare(product_codes: list[str])` — 복수 상품의 특징을 비교표 형태로 조회합니다
...
```python
# -*- coding: utf-8 -*-
"""Hook script for skill `card_product_compare` (자동 생성).
...
SKILL_NAME = 'card_product_compare'
CASE_TYPE = 'normal'
FLOW = 'query'
REQUIRED_TOOLS = ['product_search', 'product_compare']
