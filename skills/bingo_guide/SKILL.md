...
3. `bingo_mission_inquiry` 툴을 호출해 빙고 미션별 달성 기준·방법을 조회합니다.
...
```python
# -*- coding: utf-8 -*-
"""Hook script for skill `bingo_guide` (자동 생성).
...
SKILL_NAME = 'bingo_guide'
CASE_TYPE = 'normal'
FLOW = 'query'
REQUIRED_TOOLS = ['faq_search', 'bingo_mission_inquiry']
