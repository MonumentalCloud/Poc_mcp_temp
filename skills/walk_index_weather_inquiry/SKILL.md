...
- `weather_inquiry(region: Optional[str] = None)` — 설정 지역 또는 지정 지역의 날씨·기온·대기수준·산책지수를 조회합니다
...
```python
# -*- coding: utf-8 -*-
"""Hook script for skill `walk_index_weather_inquiry` (자동 생성).
...
SKILL_NAME = 'walk_index_weather_inquiry'
CASE_TYPE = 'normal'
FLOW = 'query'
REQUIRED_TOOLS = ['weather_inquiry']
