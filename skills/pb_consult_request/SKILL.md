...
```python
# -*- coding: utf-8 -*-
"""Hook script for skill `pb_consult_request` (자동 생성).
...
SKILL_NAME = 'pb_consult_request'
CASE_TYPE = 'normal'
FLOW = 'action'
REQUIRED_TOOLS = ['pb_consult_request']
ACTION_TOOLS = ['pb_consult_request']    # 사용자 확인(confirmed=True) 없이는 호출 금지
