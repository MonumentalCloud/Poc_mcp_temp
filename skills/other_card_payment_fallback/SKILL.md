...
- `other_card_usage_inquiry(company: str)` — 마이데이터 소비내역 기반 타사 카드 이용금액을 조회합니다
...
```python
# -*- coding: utf-8 -*-
"""Hook script for skill `other_card_payment_fallback` (자동 생성).
...
SKILL_NAME = 'other_card_payment_fallback'
CASE_TYPE = 'fallback'
FLOW = 'fallback'
REQUIRED_TOOLS = ['other_card_usage_inquiry']
