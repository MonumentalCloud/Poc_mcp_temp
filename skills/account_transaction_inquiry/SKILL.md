...
- `account_transaction_inquiry(target_date: Optional[str] = None, account_id: Optional[str] = None)` — 특정 일자/기간의 통장 거래내역을 조회합니다
...
```python
# -*- coding: utf-8 -*-
"""Hook script for skill `account_transaction_inquiry` (자동 생성).
...
SKILL_NAME = 'account_transaction_inquiry'
CASE_TYPE = 'normal'
FLOW = 'query'
REQUIRED_TOOLS = ['account_list_inquiry', 'account_transaction_inquiry']
