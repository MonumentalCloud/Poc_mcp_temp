---
name: glossary_insurance_term
description: '사용자가 면책기간 등 보험계약 관련 용어를 물을 때 사용합니다. 정의·필요 이유·상품별 차이 유의사항 설명에 적합합니다. 예: "면책기간이 뭐야?"'
metadata:
