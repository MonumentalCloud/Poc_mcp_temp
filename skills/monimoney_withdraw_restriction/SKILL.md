...
```python
# -*- coding: utf-8 -*-
"""Hook script for skill `monimoney_withdraw_restriction` (자동 생성).
...
SKILL_NAME = 'monimoney_withdraw_restriction'
CASE_TYPE = 'normal'
FLOW = 'query'
REQUIRED_TOOLS = ['monimoney_history_inquiry', 'monimoney_restriction_inquiry']
